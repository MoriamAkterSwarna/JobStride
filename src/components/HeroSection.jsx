        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/add-job" className="inline-flex items-center gap-2 bg-linear-to-r from-cyan-500 to-purple-500 text-white px-6 py-3 rounded-md text-lg font-medium">
                Get Started
